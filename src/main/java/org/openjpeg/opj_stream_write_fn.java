 ...
 * }
 */
public class opj_stream_write_fn {
    ...
    private static final MethodHandle UP$MH = openjpeg_h.upcallHandle(opj_stream_write_fn.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(opj_stream_write_fn.Function fi, Arena arena) {
