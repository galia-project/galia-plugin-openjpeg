...
public class __darwin_pthread_handler_rec {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        openjpeg_h.C_POINTER.withName("__routine"),
        openjpeg_h.C_POINTER.withName("__arg"),
        openjpeg_h.C_POINTER.withName("__next")
    ...
    public static class __routine {
        ...
        private static final MethodHandle UP$MH = openjpeg_h.upcallHandle(__routine.Function.class, "apply", $DESC);
